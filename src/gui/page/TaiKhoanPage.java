...
public class TaiKhoanPage extends javax.swing.JPanel {
    ...
    private void tableLayout() {
        ...
        String[] header = new String[]{"STT", "Mã tài khoản", "Username", "Tên nhân viên", "Vai Trò"};
    ...
    public void loadTable(List<TaiKhoan> list) {
        ...
        for (TaiKhoan e : listTK) {
            modal.addRow(new Object[]{String.valueOf(stt), e.getId(), e.getUsername(), e.getNhanVien().getHoTen(), e.getVaiTro().getTen()});
            stt++;
        }
    }
